...
def db_seed():
    ...
    test_user = User(first_name='Simon',
                     last_name='Diver',
                     email='sd@g.com',
                     password='Password1')
...
def login():
    ...
    if test:
        ...
        return jsonify(message='Incorrect email/password entered'), 401
...
def retrieve_password(email: str):
    ...
    if user:
        msg = Message(f"Your planetary password is {user.password}",
...
def add_planet():
    ...
    if test:
        ...
        db.session.commit()
        return jsonify(message="Congrats, you added a planet!"), 201
...
def update_planet():
    ...
    if planet:
        ...
        db.session.commit()
        return jsonify(message='You have updated a planet'), 202
    else:
        return jsonify(message="That planet doesn't exist"), 404
